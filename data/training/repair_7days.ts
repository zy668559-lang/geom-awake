...
const DRAW_LINE_DAYS: RepairDayContent[] = [
  {
    ...
    reviewTemplate: "我今天先找了___个关键点，再尝试连___条线。",
  ...
  },
  {
    ...
    reviewTemplate: "我看到垂直后，先锁定了___个直角结构。",
  ...
  },
  {
    ...
    reviewTemplate: "今天我遇到中点时，先补了___，理由是___。",
  ...
  },
  {
    ...
    reviewTemplate: "我先写了角关系___，再决定连线___。",
  ...
  },
  {
    ...
    reviewTemplate: "我补线的目标是证明___和___全等。",
  ...
  },
  {
    ...
    reviewTemplate: "我先假设补___，验证后发现___。",
  ...
  },
  {
    ...
    reviewTemplate: "这周我最稳定的补线触发词是___。",
...
const CONDITION_RELATION_DAYS: RepairDayContent[] = [
  {
    ...
    reviewTemplate: "我把条件分成___组，先用了___组。",
  ...
  },
  {
    ...
    reviewTemplate: "我先连出___条关系箭头，再下笔。",
  ...
  },
  {
    ...
    reviewTemplate: "我从求证倒推到___，再回到已知。",
  ...
  },
  {
    ...
    reviewTemplate: "我今天最关键的转换句是“因为___，所以___”。",
  ...
  },
  {
    ...
    reviewTemplate: "我原来卡在___，今天补上了___。",
  ...
  },
  {
    ...
    reviewTemplate: "我现在能把关系链从___讲到___。",
...
const PROOF_WRITING_DAYS: RepairDayContent[] = [
  {
    ...
    reviewTemplate: "我先写了结论句___，再补前提。",
  ...
  },
  {
    ...
    reviewTemplate: "我今天按三步骨架写完了___段。",
  ...
  },
  {
    ...
    reviewTemplate: "我先列___、___、___，再写全等。",
  ...
  },
  {
    ...
    reviewTemplate: "我从全等里提取了___来推进终结论。",
  ...
  },
  {
    ...
    reviewTemplate: "我把___段证明精简成___行。",
  ...
  },
  {
    ...
    reviewTemplate: "我现在写证明时最稳的模板是___。",
